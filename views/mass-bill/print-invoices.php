...
<?php
/** @var \app\models\Table_payment_bills $bill */
foreach ($model->accruedBills as $bill) {
        if(!$bill->isInvoicePrinted){
            continue;
        }
        $info = ComplexPayment::getBankInvoice($bill->id, $bill instanceof Table_payment_bills_double);
...
";
    ?>
        ...
        <div id="invoiceWrapper " class="page-break">
