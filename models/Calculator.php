...
class Calculator extends Model
{
    ...
    public static function countPower($inLimitSpend, $overLimitSpend, $cost, $overCost): float
    {
        var_dump($inLimitSpend);
        die;
        return CashHandler::toRubles($inLimitSpend * $cost + $overLimitSpend * $overCost);
    }
}