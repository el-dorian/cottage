...
/**
 * @property int $cottageNumber [int(10) unsigned]  Номер участка
 ...
 * @property int $cottageSquare [int(10) unsigned]  Площадь участка, кв.м.
 ...
 * @property int $currentPowerData [int(10) unsigned]  Последние показания счётчика электроэнергии
...
class EmergencyCottageInfo extends ActiveRecord
{
