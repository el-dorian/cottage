...
//                    return true;
    ...
    public function save(): array
    {
        ...
        try {
            ...
            // Отправлю уведомления в телеграм и firebase
            Telegram::sendDebug("Создан счёт для участка $bill->cottageNumber №$bill->id на сумму " . CashHandler::toJsRubles($bill->totalSumm));
