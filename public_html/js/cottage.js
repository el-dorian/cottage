                        ...
                        if (simple['payed-summ'] < simple['summ']) {
                            if (simple['isPayed']) {
                                if (simple['isPartialPayed']) {
                                    text += '<td><b class="text-info">Закрыт. Оплачено частично, ' + simple['payed-summ'] + ' &#8381;</b></td>';
                                }
                                else{
                                    text += '<td><b class="text-info">Закрыт. Не распределено: ' + simple['payed-summ'] + ' &#8381;</b></td>';
                                }
                                ...
                                if (simple['isPartialPayed']) {
                                    ...
                                    text += '<td><b class="text-info">Не распределено: ' + simple['payed-summ'] + ' &#8381;</b></td>';
                                }
